          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              <div key={exp.id} className="relative mb-16 last:mb-0">
                {/* Timeline dot */}
                <motion.div
                  className="hidden md:block absolute left-1/2 top-0 transform -translate-x-1/2 w-6 h-6 bg-gradient-to-r from-primary-600 to-purple-600 dark:from-primary-400 dark:to-purple-400 rounded-full border-4 border-white dark:border-gray-900 shadow-lg z-10"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  viewport={{ once: true }}
                ...
                >
                  <div className="group bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl p-6 md:p-8 border-2 border-gray-100 dark:border-gray-700 hover:border-primary-400 dark:hover:border-primary-500 transition-all duration-300">
                    <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                      ...
                      {exp.current && (
                        <motion.span
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-full shadow-md whitespace-nowrap"
